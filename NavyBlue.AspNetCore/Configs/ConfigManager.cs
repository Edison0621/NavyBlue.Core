...
namespace NavyBlue.NetCore.Lib.Configs
{
    ...
    public class ConfigManager
    {
        ...
        public List<string> GetIPWhitelists()
        {
            if (this.Config == null)
            {
                return this.GetSourceConfig().Configurations.FromJson<NBConfig>().IPWhitelists;
            }
        ...
        public Dictionary<string, string> GetResources()
        {
            if (this.Config == null)
            {
                return this.GetSourceConfig().Configurations.FromJson<NBConfig>().Resources;
            }
        ...
        private SourceConfig GetSourceConfig()
        {
            ...
            else
            {
                ...
                {
                    Task.Run(() => this.RefreshConfig()).Wait();
                }
            }
        ...
        private void RefreshConfig()
        {
            if (!this.isConfigRefreshing)
            {
                ...
                catch (Exception e)
                {
                    ...
                    if (this.SourceConfig == null)
                    {
                        throw new Exception("Can not init configurations!", e);
                    }
                }
                finally
                {
