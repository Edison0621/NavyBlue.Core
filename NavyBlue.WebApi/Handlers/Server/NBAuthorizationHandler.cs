// *****************************************************************************************************************
// Project          : NavyBlue
// File             : NBAuthorizationHandler.cs
// Created          : 2019-01-14  17:14
//
// Last Modified By : (jstsmaxx@163.com)
// Last Modified On : 2019-01-14  17:24
// *****************************************************************************************************************
// <copyright file="NBAuthorizationHandler.cs" company="Shanghai Future Mdt InfoTech Ltd.">
...
{
    /// <summary>
    ///     NBAuthorizationHandler.
    /// </summary>
    public class NBAuthorizationHandler : DelegatingHandler
    {
        private const string CRYPTO_SERVICE_PROVIDER_ERROR_MESSAGE = "NBAuthorizationHandler CryptoServiceProvider can not initialize. The GovernmentServerPublicKey may be in bad format. GovernmentServerPublicKey: {0}";
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="NBAuthorizationHandler" /> class.
        /// </summary>
        /// <param name="bearerAuthKeys">The bearerAuthKeys.</param>
        public NBAuthorizationHandler(string bearerAuthKeys)
        {
        ...
        public NBAuthorizationHandler(string bearerAuthKeys, string governmentServerPublicKey)
        {
            this.accessTokenProtector = new NBAccessTokenProtector(bearerAuthKeys);
