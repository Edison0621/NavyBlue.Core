// *****************************************************************************************************************
// Project          : NavyBlue
// File             : NBLogHandler.cs
// Created          : 2019-01-14  17:14
//
// Last Modified By : (jstsmaxx@163.com)
// Last Modified On : 2019-01-14  17:24
// *****************************************************************************************************************
// <copyright file="NBLogHandler.cs" company="Shanghai Future Mdt InfoTech Ltd.">
...
namespace NavyBlue.AspNetCore.Web.Handlers
{
    ...
    ///     NBLogHandler.
    /// </summary>
    public class NBLogHandler : DelegatingHandler
    {
        /// <summary>
        ///     The logger
        /// </summary>
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="NBLogHandler" /> class.
        /// </summary>
        public NBLogHandler(string requestTag, string responseTag)
        {
